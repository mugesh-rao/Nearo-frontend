...
const OutofStock = () => {
  ...
  const send_lowstock_session = (data) =>
    apiRequest({
      url: "/inventory/get_ots_product_list",
      method: "post",
      data: data,
    });
      ...
      <div className=" bg-white sm:mx-2 py-8">
        ...
        <div className="flex justify-between mx-2 items-center">
          <div className="hidden  sm:flex text-2xl font-semibold lg:text-3xl ">
            <h1 className="capitalize">out of stock</h1>
            {lowData && (
              <div className="h-[40px] w-[50px] bg-[#E5E2F5] mx-2 rounded-lg grid place-items-center">
                <span className="text-[#9313F8] text-[1.5rem]">
                    ...
                    <>
                      ...
                      >
                        ...
                        <LazyImage
                          ...
                          className="block -z-10 object-cover -mt-[45px] aspect-[4/4] h-[240px] w-full rounded-t-lg "
                        />
