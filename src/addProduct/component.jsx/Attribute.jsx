...
const Attribute = ({ category_last_id, attributesID, setAttributeID }) => {
  ...
  return (
    <div className="grid grid-cols-1 w-full gap-x-10 gap-y-4 items-center c500:grid-cols-2">
      {CategoryAttributes &&
        CategoryAttributes.map((val, index) => (
          <Fragment key={val.id}>
            <label htmlFor="Fabric" className="w-full ">
              <p>
                {val.title} <span className="text-red-500 text-xl"></span>
              </p>
              ...
              <div className="relative">
                <div
                  ...
                  onClick={() => handleToggle(index, +val.id)}
                >
                ...
                {isOpen[index] && (
                  <div
                    className="fixed bottom-0 top-0 right-0 left-0 z-10 opacity-20"
                    ...
                    </div>
{
                (!loads) ?    <ul>
                    ...
                    </ul>: <div className=" h-[200px] w-full grid place-items-center  bg-white">
                    <Loader />
                  </div>}
